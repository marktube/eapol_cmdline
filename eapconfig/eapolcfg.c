...
//private framework functions declaration
const char *
...
int
EAPOLControlStartSystemWithClientItemID(const char * interface_name, EAPOLClientItemIDRef itemID);
int
EAPOLControlStartWithClientItemID(const char * if_name, EAPOLClientItemIDRef itemID, CFDictionaryRef auth_info);

void SCPrint(Boolean, FILE*, CFStringRef, ...);
